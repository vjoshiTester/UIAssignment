@AC05 @Regression1 @test21
Feature: AC05 - Advisor check in Elsa2Go Integration function
  ...
  Scenario Outline: Verify the Advisor check In Elsa2Go Integration function in Test2 with <OEM>
    ...
    Examples: below data set for data driven
      | URL     | DMS     | DealerName          | <OEM> | CustomerName | Odometer | Application     |
      | TEST2DFX | Elsa2Go | Audi of anytown usa | Audi  | dfx          |     1234 | ADVISOR CHECKIN |
