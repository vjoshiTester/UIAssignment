@AC10 @Regression1
Feature: AC10 - Create Symptom Survey
  Description : The purpose of this feature is to verify the create symptom feature

  @AC-CreateSymptomSurvey
  Scenario Outline: Create Symptom Survey
    ...
    And I validate selected "<SymptomSurvey>" is displayed correctly
