@TIONE14 @TIONE
Feature: TIONE14_TechnicianInspection_PriceRec, update price on recommendation tab
  @tione_update_price_recTab
  Scenario Outline: [@ti_update_price_recTab] update price on recommendation tab
    ...
    When I update "10.00" in "hours" with "Test1" Description on 'RECOMMENDATION' tab
    #And I update "20.00" in "labor" with "Test1" Description on 'RECOMMENDATION' tab
    And I update "2" in "Labor Rate" with "Test1" Description on 'RECOMMENDATION' tab
    And I update "100.00" in "parts" with "Test1" Description on 'RECOMMENDATION' tab
    And I click "Save" button on 'MPI Details' page
    And I click "vehicle queue" icon on 'MPI Details' page
    And I click vehicle "<VIN>" on 'TECHNICIAN INSPECTION Dashboard'
    Then I should see recommendation with "Test1" Description with "10.00" hours with "20.00" labor with "100.00" parts with "120.00" price on 'RECOMMENDATION' tab
    ...
    And  I should see recommendation with "Test1" Description with "10.00" hours with "20.00" labor with "100.00" parts with "120.00" price on 'RECOMMENDATION' tab
    When I update "20.00" in "hours" with "Test1" Description on 'RECOMMENDATION' tab
    #And I update "30.00" in "labor" with "Test1" Description on 'RECOMMENDATION' tab
    And I update "1.5" in "Labor Rate" with "Test1" Description on 'RECOMMENDATION' tab
    And I update "200.00" in "parts" with "Test1" Description on 'RECOMMENDATION' tab
    And I click "Save" button on 'MPI Details' page
    ...
    And I should see recommendation with "Test1" Description with "20.00" hours with "30.00" labor with "200.00" parts with "230.00" price on 'RECOMMENDATION' tab
    ...
    Then I should see "RECOMMENDED" with "$230.00" on 'footbar' tab
    And I should see "APPROVED" with "$230.00" on 'footbar' tab
    ...
    And I should see "Test1" Description with "20.00" labor with "$230.00" price in 'recommendations' section on 'APPROVED SERVICES' tab
    ...
    Examples: this is for data driver testing
      ...
      |PROD1  |CHRYSLER QA|99970     |Rec01 |1C3CCBCGXDN674128|Chrysler Vehicle Inspection|