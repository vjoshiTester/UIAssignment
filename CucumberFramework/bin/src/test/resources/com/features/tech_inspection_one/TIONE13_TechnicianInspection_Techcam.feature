@TIONE13 @TIONE
Feature: TIONE13_TechnicianInspection_Techcam, Technician Inspection with Tech Cam
  ...
  4.verify the recommendation attach to the photo
    ...
    Examples: this is for data driver testing
      ...
      |PROD1  |CHRYSLER QA|99970     |flow13 |1C3CCBCGXDN674128|Chrysler Vehicle Inspection|
