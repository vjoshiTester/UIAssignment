@TIONE08 @TIONE
Feature: TIONE08_TechnicianInspectionFlow_parts, main flow with parts requested
...
#    And I click "vehicle queue" icon on 'MPI Details' page
    ...
    Examples: this is for data driver testing
      ...
      |PROD1  |CHRYSLER QA|99970     |flow3 |1C3CCBCGXDN674128|Chrysler Vehicle Inspection|