@TIONE11 @TIONE
Feature: TIONE11_TechnicianInspection_Comment, main flow with Comments
  ...
  Description :
    ...
    And I input "Parts Clerk edit cusotmer comment in Description" on "Customer Comments" field on "description" section with "Test1" Description on "RECOMMENDATION" tab
    And I click "Save" button on 'MPI Details' page
    ...
    And I should see "Parts Clerk edit cusotmer comment in Description" on "Customer Comments" field on "description" section with "Test1" Description on "RECOMMENDATION" tab
    ...
    And I input "Advisor edit cusotmer comment in Description" on "Customer Comments" field on "description" section with "Test1" Description on "RECOMMENDATION" tab
    And I click "Save" button on 'MPI Details' page
...
#    And I click "vehicle queue" icon on 'MPI Details' page
    ...
    And I should see "Advisor edit cusotmer comment in Description" on "Customer Comments" field on "description" section with "Test1" Description on "RECOMMENDATION" tab
    ...
    Examples: this is for data driver testing
      ...
      |PROD1  |CHRYSLER QA|99970     |com01 |1C3CCBCGXDN674128|Chrysler Vehicle Inspection|
