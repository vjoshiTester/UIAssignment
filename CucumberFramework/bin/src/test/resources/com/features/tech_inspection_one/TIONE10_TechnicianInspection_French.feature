@TIONE10 @TIONE
Feature: Technician Inspection, French (Chrysler Certified Vehicle Inspection and Chrysler Express Vehicle Inspection template)

  @tionefrench_dashboard
  Scenario Outline: [@tifrench_dashboard] check dashboard in french version
    #Login as Service Technician
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    When I login the Application as User "DarrenFCAT" and password "welcome"
    ...
    And I "Marquer la section tout OK" on "MPI Details" page
    And I click "Red" icon on "Phares de route et de croisement" inspection on 'INSPECTION' tab
    ...
    Then I should see the following French verbiage shows on "Inspection Detail" page
      ...
      | High/low beam lights            | Phares de route et de croisement      |
      | Checked and OK at this time     | Vérifié et en règle                   |
      | May require future attention    | Attention ultérieure peut être requise|
      | Requires immediate attention    | Attention immédiate requise           |
    ...
    And I click "RECOMMANDATION" button on "MPI" page in French
    ...
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    When I login the Application as User "DarrenFCAP" and password "welcome"
    And I click 'Click Here to Select your Dealership' on 'Home' page
    And I select Dealer with "<DealerName>" and "<DealerCode>" on DFX Page
    And I launch "Technician Inspection" Application on 'Main Page'
    #Change to French version
    ...
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    When I login the Application as User "DarrenFCAA" and password "welcome"
    And I click 'Click Here to Select your Dealership' on 'Home' page
    And I select Dealer with "<DealerName>" and "<DealerCode>" on DFX Page
    And I launch "Technician Inspection" Application on 'Main Page'
    ...
    Examples: this is for data driver testing
      ...
      |TEST1DFX |Chrysler Canada QA|C0538     |fr01  |1C3CCBCGXDN674128|Chrysler Certified Vehicle Inspection|
      #|TEST1DFX |Chrysler Canada QA|C0538     |fr01  |1C3CCBCGXDN674128|Chrysler Express Vehicle Inspection  |