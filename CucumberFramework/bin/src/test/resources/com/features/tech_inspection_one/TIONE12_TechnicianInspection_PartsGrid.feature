@TIONE12 @TIONE
Feature: TIONE12_TechnicianInspection_PartsGrid, Parts Grid
...
#    And I enter data set in addRecommendationField
    And I enter data set in addRecommendationField under "Left Front Wipers" section
      | FieldName         |Value  |
    ...
    And I click "Red" icon on "Right Front Wipers" inspection on 'INSPECTION' tab
#    And I enter data set in addRecommendationField
    And I enter data set in addRecommendationField under "Right Front Wipers" section
      | FieldName         |Value  |
...
#    And I click "Parts Requested" button on 'Inspection Detail' page
#    And I click "Save" button on 'Inspection Detail' page
    And I click "plus" icon under "Right Front Wipers" section on 'Inspection Detail' page
    And I click "Parts Requested" button under "Right Front Wipers" section on 'Inspection Detail' page
    And I click "Save" button under "Right Front Wipers" section on 'Inspection Detail' page
    ...
    And I should see recommendation with "Test1" Description with "2.50" hours with "25.50" labor with "665.00" parts with "690.50" price on 'RECOMMENDATION' tab
    ...
    Examples: this is for data driver testing
      ...
      |PROD1  |CHRYSLER QA|99970     |part1 |1C3CCBCGXDN674128|Chrysler Vehicle Inspection|