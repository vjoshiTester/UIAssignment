@MCI08 @Regression
Feature: MCI08_MCIForExistingCustomers
  Description: Verify Mobile Check-In function work properly for existing customers

  Scenario Outline: Verify Mobile Check-In function work properly for existing customers
    ...
    Examples: below data set for data driven
      | URL      | DMS   | DealerName           | ServiceAdvisor | Odometer | URL2         |
      | TEST2DFX | Dummy | Anytown USA Automall |              1 |    35001 | TEST2MCIAUDI |
