@TI22 @TI
Feature: TI22_TechnicianInspection_ResponseTime, Technician Inspection, check launch/save EVIR response time
  ...
  Description :
    ...
    Then I expect launch EVIR <VIN> in 'TECHNICIAN INSPECTION Dashboard' within "5" seconds
    # Add recommendation for concern
    When I click "Red" icon on "AC Heating Concern" concern on 'INSPECTION' tab
...
#    And I click "Save" button on 'Inspection Detail' page
    ...
    Then I expect click "Save" button on 'MPI Details' pages within "5" seconds
    ...
    Then I expect click "Save" button on 'MPI Details' pages within "5" seconds
    When I click "Parts Request Completed" button on 'RECOMMENDATION' page
    ...
    Then I expect click "vehicle queue" icon on 'MPI Details' pages within "5" seconds
    And I see vehicle with "<VIN>" with "REVIEWED" status on 'TECHNICIAN INSPECTION Dashboard'
