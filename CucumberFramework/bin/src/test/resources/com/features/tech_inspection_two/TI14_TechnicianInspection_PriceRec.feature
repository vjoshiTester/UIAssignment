@TI14 @TI
Feature: TI14_TechnicianInspection_PriceRec, Technician Inspection, update price on recommendation tab
  ...
  Scenario Outline: [@ti_update_price_recTab] update price on recommendation tab
    ...
    #And I click vehicle <VIN> in 'TECHNICIAN INSPECTION Dashboard'
