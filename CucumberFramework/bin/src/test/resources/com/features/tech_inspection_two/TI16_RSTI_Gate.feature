@TI16 @TI
Feature: TI16_RSTI_Gate, RS gating moving
...
#    And I enter data set in addRecommendationField
    ...
    Examples: this is for data driver testing
      ...
      |PRD2AUDI   |Audi of Anytown Canada|408A85CA  |Gate1 |WAUFGAFB0BN005982|

  @tiflow_RSGate_Skip_Parts
  Scenario Outline: [@tiflow_RSGate_Skip_Parts] run TI from started status to ready for processing status, RS gate moving (skip parts requested)
    ...
    Examples: this is for data driver testing
      |URL        |DealerName            |DealerCode|TAG   |VIN              |
      |PRD2AUDI   |Audi of Anytown Canada|408A85CA  |Gate1 |WAUFGAFB8AN084543|