@TI19 @TI
Feature: TI19_ServiceDashboard_OpenTi, Open technician inspection from service dashboard
  ...
  Scenario Outline: [@tiflow_opentifromrs] run TI from started status to ready for processing status, open ti from rs
    ...
    And I login the Application as User "exie" and password "19890520Emily"
 ...
 #  And I decode <VIN> on 'Advisor Check-In' page
    ...
    And I input "This is Internal Comment entered by Tech" in "Internal Comment" field under "Windshield Condition" section on 'Inspection Detail' page
#    And I click "Save" button on 'Inspection Detail' page
...
#    Given I launch browser "chrome" in "headless" and open "<URL>"
    Given I launch browser "chrome" in "GUI" and open "<URL>"
...
#    Given I launch browser "chrome" in "headless" and open "<URL>"
    ...
    Examples: this is for data driver testing
      ...
      |PRD2AUDI   |Audi of Anytown Canada|408A85CA  |RS01  |WA1WAAF73HD015284|
#      |TST2AUDI   |Audi of Anytown Canada|408A85CA  |RS01  |WA1WAAF73HD015284|
#      |STG2AUDI   |Audi of Anytown Canada|408A85CA  |RS01  |WA1WAAF73HD015284|
