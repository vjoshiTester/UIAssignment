@AM21 @Sanity1 @Regression2 @FCA_Regression @FCA_Sanity
Feature: AM21_Regression_CreateASyncApptError, This test suite is Appointment Management Regression suite
  Description: To create asynchronous appointment with VIN

Scenario Outline: AM_Regression21, Verify the functionality to create an appointment with VIN asynchronously
Given I launch browser "chrome" in "GUI" and open "<URL>"
    ...
    When I input comment "Error" on 'SUMMARY' page
	...
	And I check DMS Status as "Error" for this Appointment on 'DASHBOARD' page
    ...
    Examples: below data set for data driven
      ...
      |TEST2ALNISS  |Dummy        |              |ANYUSAAUTOMALL      |dfx             |1             |35001    |Appointment Manager|
