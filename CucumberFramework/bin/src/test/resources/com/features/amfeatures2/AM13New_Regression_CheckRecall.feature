...
Feature: AM13_Regression_CheckRecall. This test suite is Appointment Management Regression suite
  ...
  Scenario Outline: AM_Regression13.1, Verify the Appointment Management Recall function on Vehicle page and Service page
    ...
    Examples: below data set for data driven
      | URL         | DMS   | DealerName            | DealerCode | VIN               | Recall | Odometer |Application|
      | TEST2ALNISS | Dummy | Toyota of anytown usa |            | 1NXBR32EX5Z365791 | yes    |    51000 |Appointment Manager|
      | TEST2ALNISS | Dummy | Toyota of anytown usa |            | 4T1BF1FK5GU226278 | no     |    51000 |Appointment Manager|
  ...
  Scenario Outline: AM_Regression13.2Verify the Appointment Management Recall function on Vehicle page and Service page
    ...
    Examples: below data set for data driven
      | URL         | DMS   | DealerName         | DealerCode | VIN               | Recall | Odometer |Application|
      | TEST2ALNISS | Dummy | Capital Mitsubishi |            | JA32U2FU4DU609656 | yes    |    52000 |Appointment Manager|
      | TEST2ALNISS | Dummy | Capital Mitsubishi |            | JA4JT3AX0BU601908 | no     |    52000 |Appointment Manager|
  ...
  Scenario Outline: AM_Regression13.3,Verify the Appointment Management Recall function on Vehicle page and Service page
   ...
   And I move to switch dealer window on 'Home' page
    ...
    Examples: below data set for data driven
      | URL         | DMS   | DealerName  | DealerCode | VIN               | Recall | Odometer |Application|
      | TEST2ALNISS | Dummy | Sisk Nissan |            | 1N6AA07C68N321957 | yes    |    53000 |Appointment Manager|
  ...
  Scenario Outline: AM_Regression13.4, Verify the Appointment Management Recall function on Vehicle page and Service page
    ...
    Examples: below data set for data driven
      | URL         | DMS   | DealerName  | DealerCode | VIN               | Recall | Odometer |Application|
      | TEST2ALNISS | Dummy | Sisk Nissan |            | 1N4AA5AP4BC855303 | no     |    56000 |Appointment Manager|
  ...
  Scenario Outline: AM_Regression13.4, Verify the Appointment Management Recall function on Vehicle page and Service page
    ...
    Examples: below data set for data driven
      | URL         | DMS   | DealerName  | DealerCode | VIN               | Recall  | Odometer |Application|
      | TEST2ALNISS | Dummy | chrysler qa |            | 1J4GL38K43W538970 | yes     |    56000 |Appointment Manager|
      | TEST2ALNISS | Dummy | chrysler qa |            | 1G11C5SA1DF302116 | no      |    56000 |Appointment Manager|
