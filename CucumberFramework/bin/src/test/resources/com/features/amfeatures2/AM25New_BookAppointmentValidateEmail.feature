@AM25 @Regression2 @FCA_Regression 
Feature: AM25_Regression_CreateCustomerAppValidateCancellationEmail, This test suite is Appointment Management Regression suite
  Description: to verify Appointment Management function work properly

  @AM_Regression25_CreateNewAppointmentByVIN-TEST2-AUDI
  Scenario Outline: @AM_Regression25 Verify the email after an appointment is deleted
