...
Feature: AM15_Regression_CreateApptWithoutVIN, This test suite is Appointment Management Regression suite
  ...
  @AM_Regression15_CreateNewApptWithoutVIN-TEST2-Dummy @DMSOnly_AM
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    ...
    Examples: below data set for data driven
      ...
      |TEST2ALAUDI  |Dummy     |Audi of anytown usa  |35001    |Appointment Manager|
      
      
      
      
      
      @AM_Regression15_CreateNewApptWithoutVIN-TEST2-R&R @DMSOnly_AM
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    ...
    Examples: below data set for data driven
      |URL          |DMS       |DealerName           |Odometer |Application|
      |TEST2ALAUDI  |R&R       |Woodfield Lexus      |35001    |Appointment Manager|
      ...
      @AM_Regression15_CreateNewApptWithoutVIN-TEST2-CDK @DMSOnly_AM
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    ...
    Examples: below data set for data driven
      |URL          |DMS       |DealerName           |Odometer |Application|
      |TEST2ALAUDI  |CDK       |Capital Mitsubishi   |35001    |Appointment Manager|
      ...
      @AM_Regression15_CreateNewApptWithoutVIN-TEST2-Automate @DMSOnly_AM
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    ...
    Examples: below data set for data driven
      |URL          |DMS       |DealerName           |Odometer |Application|
      |TEST2ALAUDI  |Automate  |Audi of anytown usa  |35001    |Appointment Manager|
      ...
      @AM_Regression15_CreateNewApptWithoutVIN-TEST2-PBS @DMSOnly_AM
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    ...
    Examples: below data set for data driven
      |URL          |DMS       |DealerName           |Odometer |Application|
      |TEST2ALAUDI  |PBS       |Rallye Mitsubishi    |35001    |Appointment Manager|