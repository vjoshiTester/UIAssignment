...
Feature: Test flow from Appointment manager to Advisor-Checkin
  ...
  2)using the same appointment and complete RO push in advisor checkin
    ...
    Examples: below data set for data driven
     |URL       |DealerName        |DealerCode |DMS|Odometer   |TAG   |VIN              |ServiceAdvisor|
     |TEST2DFX |Capital Mitsubishi|80003      |CDK|50000      |random|3N1CE2CP3FL385832| first        |
