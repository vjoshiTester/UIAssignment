# new feature
@AC @ADVISORDASHBOARD @ADVISORCHECKIN @ACCLOUDRNR

Feature: Advisor check in RO push for <Cloud R&R>
  ...
  Scenario Outline: Advisor check in RO push for <DMS>
    ...
    Examples: below data set for data driven
      ...
      |PROD2AD  |Cloud R&R  |Audi Boundary   |4991450     |testing     |50000   |yes        |TEST     |WAUVT64B92N108227|