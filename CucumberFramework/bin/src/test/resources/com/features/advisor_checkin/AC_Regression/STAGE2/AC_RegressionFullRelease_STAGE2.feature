@AC-RegressionFullRelease-STAGE2
Feature: AC function, Including the Customer Search,  etc, Regression full test on STAGE2
  ...
  @AC-RegressionFullRelease-CustomerSearch-STAGE2
  Scenario Outline: Verify the Advisor checkin customer search function
    ...
    Examples: below data set for data driven
      ...
      |STAGE2AD  |Audi of Anytown USA  |Customer Search Functionality   |dfx         |416-493-0039   |Olga-2222      |WAUSGCFCXCN002530|

  @AC-RegressionOEM-STAGE2-AUDI
  Scenario Outline: Verify the Advisor Check In Push RO properly for AUDI <OEM>
    ...
    Examples: below data set for data driven
      ...
      |STG2ADAUDI   |Audi Framework       |anytown usa automall   |Audi        |2.9.19035.01     |TEST        |21431    |TagAu    |

  @AC-RegressionOEM-STAGE2-Mitsubishi
  Scenario Outline: Verify the Advisor Check In Push RO properly for Mitsubishi <OEM>
    ...
    Examples: below data set for data driven
      |URL          |DMS                  |DealerName             |OEM         |AD_VersionNumber |CustomerName|Odometer |TagNumber|
      |STG2ADMITS   |Mitsubishi Framework |anytown usa automall   |Mitsubishi  |2.9.19035.01     |TEST        |21431    |TagMi    |

  @AC-RegressionOEM-STAGE2-Toyota
  Scenario Outline: Verify the Advisor Check In Push RO properly for Toyota <OEM>
    ...
    Examples: below data set for data driven
      |URL          |DMS                  |DealerName             |OEM         |AD_VersionNumber |CustomerName|Odometer |TagNumber|
      |STG2ADTOYO   |Toyota Framework     |toyota of anytown usa  |Toyota      |2.9.19035.01     |TEST        |21431    |TagTo    |

  @AC-RegressionOEM-STAGE2-lexus
  Scenario Outline: Verify the Advisor Check In Push RO properly for lexus <OEM>
    ...
    Examples: below data set for data driven
      |URL          |DMS                  |DealerName             |OEM         |AD_VersionNumber |CustomerName|Odometer |TagNumber|
      |STG2ADLEXU   |Lexus Framework      |lexus of anytown usa   |Lexus       |2.9.19035.01     |TEST        |21431    |Taglu    |

  @AC-RegressionOEM-STAGE2-Nissan
  Scenario Outline: Verify the Advisor Check In Push RO properly for Nissan <OEM>
    ...
    Examples: below data set for data driven
      |URL          |DMS                  |DealerName             |OEM         |AD_VersionNumber |CustomerName|Odometer |TagNumber|
      |STG2ADNISS   |Nissan Framework     |nissan of anytown usa  |Nissan      |2.9.19035.01     |TEST        |21431    |TagNi    |

  @AC-RegressionOEM-STAGE2-Infiniti
  Scenario Outline: Verify the Advisor Check In Push RO properly for Infiniti <OEM>
    ...
    Examples: below data set for data driven
      |URL          |DMS                  |DealerName             |OEM         |AD_VersionNumber |CustomerName|Odometer |TagNumber|
      |STG2ADINFI   |Infiniti Framework   |Anytown Infiniti USA   |Infiniti    |2.9.19035.01     |TEST        |21431    |TagIN    |

  @AC-Regression-DealerTire-STAGE2-Nissan
...
#    And I click "NEXT" button on 'Advisor Check-In' page
    ...
    Examples: below data set for data driven
      ...
      |STAGE2AD   | DealerTire   |BEAVER COUNTY NISSAN INC  |21431   |1N4AL21E59C104101  |Nissan      |TESTING        |

  @AC-Regression-Elsa2GO-STAGE2-Audi
  Scenario Outline: Verify the Advisor check In Elsa2Go Integration function in STAGE2 with <OEM>
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "<DealerName>" or "" in Dealer Page
    ...
    Examples: below data set for data driven
      ...
      |STAGE2AD      |Elsa2Go              |Audi of anytown usa    |Audi         |dfx         |1234     |

  @AC-Regression-maintainCalculation-STAGE2-Audi-noVIN
  Scenario Outline: Verify the function on Calculation of maintenance without Decode VIN
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "<DealerName>" or "" in Dealer Page
    ...
    Examples: below data set for data driven
      ...
      |STG2ADAUDI   |Menu Only   |audi of anytown usa menu   |35001    |

  @AC-Regression-maintainCalculation-STAGE2-Audi-ByVIN
  Scenario Outline: Verify the function on Calculation of maintenance by Decode VIN
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "<DealerName>" or "" in Dealer Page
  ...
  @AC-Regression-TimeVSMileage-STAGE2-VW
  Scenario Outline: Verify the Advisor check Maintenance Time&Mileage documentation function
    ...
    Examples: below data set for data driven
      ...
      | STG2ADVOLK | vwFramework | Volkswagen of Naples |            | 1000      | 56478     | 1VWCV7A30FC001749  |