# new feature
@AC @ADVISORDASHBOARD @ADVISORCHECKIN @ACPBS

Feature: Advisor check in RO push for <PBS>
  ...
  Scenario Outline: Advisor check in RO push for <DMS>
    ...
    And I change "TestTest123" in "LAST NAME" field on "CUSTOMER" page
    And I click "NEXT" button on 'CUSTOMER' page
    And I add following customer concerns on 'CONCERN' page
      |Concern name                          |
      |35,000 Mile Service (Toyota Care Plus)|
      |40,000 Mile Service (Toyota Care Plus)|
    ...
    Examples: below data set for data driven
      ...
      |PROD2AD  |PBS        |Beaverton Toyota|36047       |testing     |4700    |yes        |TEST     |VNKKTUD39HA082562|