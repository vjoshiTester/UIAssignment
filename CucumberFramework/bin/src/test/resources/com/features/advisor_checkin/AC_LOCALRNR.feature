# new feature
@AC @ADVISORDASHBOARD @ADVISORCHECKIN @ACRNR

Feature: Advisor check in RO push for <Local R&R>
  ...
  Scenario Outline: Advisor check in RO push for <DMS>
    ...
    Examples: below data set for data driven
      ...
      |PROD2AD  |Local R&R  |Lexus of oakville|955_LOO     |testing     |4700    |yes        |TEST     |2T2HK31U99C097794|