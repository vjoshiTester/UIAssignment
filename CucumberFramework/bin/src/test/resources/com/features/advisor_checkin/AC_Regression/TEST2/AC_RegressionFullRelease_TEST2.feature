@AC-RegressionFullRelease-TEST2
Feature: AC function, Including the Customer Search, etc. Regression full test on ENV TEST2
  ...
  @AC-RegressionFullRelease-CustomerSearch-Test2
  Scenario Outline: Verify the Advisor checkin customer search function
    ...
    Examples: below data set for data driven
      ...
      |TEST2AD   |Audi of Anytown USA  |Customer Search Functionality   |dfx         |416-493-0039   |Olga-2222      |WAUSGCFCXCN002530|
...
#    And I click "NEXT" button on 'Advisor Check-In' page
    ...
    Examples: below data set for data driven
      ...
      |TEST2AD   | DealerTire   |BEAVER COUNTY NISSAN INC  |21431   |1N4AL21E59C104101  |Nissan      |TESTING        |

  @AC-Regression-Elsa2GO-Test2-Audi
  ...
  @AC-Regression-maintanCalculation-TEST2-Audi-noVIN
  Scenario Outline: Verify the function on Calculation of maintainance without Decode VIN
    ...
    Examples: below data set for data driven
      ...
      |TST2ADAUDI   |Menu Only   |audi of anytown usa menu   |35001    |
  ...
  Scenario Outline: Verify the function on Calculation of maintainance by Decode VIN
    ...
    Examples: below data set for data driven
      ...
      |TST2ADAUDI   |Menu Only   |audi of anytown usa menu   |35001    |WAUJ8GFFXG1034028 |https://auditd.dealer-fx.com|

  @AC-Regression-TimeVSMileage-TEST2-VW
