...
@AC-RegressionRecall-STAGE2
Feature: AC_OEMRecall, Advisor Check In Morning Health Check on RO push, Test on ENV STAGE2
  ...
  @AC-RegressionRecall-STAGE2-Toyota
...
#      |STAGE2AD |South Dade Toyota   |Recalls     |Toyota      |JTDBT4K3XA1352478 |Y      |N        | Y        |
      |STAGE2AD |South Dade Toyota   |Recalls     |Toyota      |4T4BF3EK2AR031085 |N      |N        | Y        |

#  @AC-RegressionRecall-STAGE2-GM
#  Scenario Outline: Advisor check Verify OEM Recalls and Contract on RO push for <DMS>
#  Description :
#    Given I launch browser "chrome" in "GUI" and open "<URL>"
#    And I set "<DMS>" to the 'DMS'
...
#    Examples: below data set for data driven
#      |URL      |DealerName                |DMS         |VehicleMaker|VIN              |Recalls|CONTRACT | WARRANTY |
#      |STAGE2AD |Midway Chevrolet GM       |Recalls     |GM          |1GT12UEY1HF226593|Y      |N        | Y        |
#      |STAGE2AD |Midway Chevrolet GM       |Recalls     |GM          |1G4ZP5SZ4JU122474|N      |N        | Y        |

  @AC-RegressionRecall-STAGE2-Mitsubishi
  Scenario Outline: Advisor check Verify OEM Recalls and Contract on RO push for <DMS>
  Description :
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    ...
    Examples: below data set for data driven
      |URL     |DealerName          |DMS         |VehicleMaker|VIN              |Recalls|CONTRACT | WARRANTY |
      |STAGE2AD |Barrie Mitsubishi   |Recalls     |Mitsubishi  |ML32A3HJ9FH040630|Y      |N        | Y        |
#      |STAGE2AD |Barrie Mitsubishi   |Recalls     |Mitsubishi  |JA32U2FU4FU602712|N      |N        | Y        |

#  @AC-RegressionRecall-STAGE2-Nissan
#  Scenario Outline: Advisor check Verify OEM Recalls and Contract on RO push for <DMS>
#  Description :
#    Given I launch browser "chrome" in "GUI" and open "<URL>"
#    And I set "<DMS>" to the 'DMS'
...
#    Examples: below data set for data driven
#      |URL     |DealerName          |DMS         |VehicleMaker|VIN              |Recalls|CONTRACT | WARRANTY |
#      |STAGE2AD |AUTOCENTERS NISSAN  |Recalls     |Nissan      |1N6AA07C68N321957|Y      |N        | Y        |
#      |STAGE2AD |AUTOCENTERS NISSAN  |Recalls     |Nissan      |5N1AT2MT9EC853221|N      |Y        | Y        |
#      |STAGE2AD |AUTOCENTERS NISSAN  |Recalls     |Nissan      |3N1CB51D56L487412|N      |N        | Y        |
#      |STAGE2AD |AUTOCENTERS NISSAN  |Recalls     |Nissan      |5N1AR2MN3EC692834|Y      |Y        | Y        |