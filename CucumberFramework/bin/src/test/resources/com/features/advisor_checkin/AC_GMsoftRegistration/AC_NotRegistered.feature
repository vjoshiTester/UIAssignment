...
Feature: GM Soft Pushing RO for customer and not registering

  Scenario Outline: Pushing RO for customer and not registering
    ...
    Then I should see following info displayed on "AUTHORIZATION" page
      ...
      |OWNER REGISTRATION|
      |Yes/No toggle     |
    And I set "Yes/No" toggle to "NO" on "AUTHORIZATION" page
