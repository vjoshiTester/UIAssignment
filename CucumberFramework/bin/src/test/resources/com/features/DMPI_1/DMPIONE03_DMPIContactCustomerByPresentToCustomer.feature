...
Feature: DMPI present to customer for FCA environment
  ...
  Scenario Outline: Dynamic multi point inspection, verify message to customer By presenting
    ...
    #And I select Dealer with <DealerName> and <DealerCode> in DFX Page
    #And I launch "Advisor Check-In" Application in 'Main Page'
    ...
    #create service lane from the wiadvisor
    Given I launch browser "chrome" in "GUI" and open "<WiadvisorURL>"
    ...
    And I search customer "<VIN>" under "Search" tab
    ...
    And I click "Continue" button in 'WiAdvisorRO' page
#    And I enter "<TAG>" under "Tag" field on "Assign RO" tab
    And I click "Continue" button in 'WiAdvisorRO' page
    And I click "Continue" button in 'WiAdvisorRO' page
    And I click "Continue" button in 'WiAdvisorRO' page
    ...
    And I login the Application as User "DarrenT" and password "welcome"
    ...
    |WiadvisorURL |URL    |DMS |DealerName  |DealerCode|Odometer|TAG     |VIN              |
    |PROD1WI      |PROD1  | ?  |CHRYSLER QA |99970     |60000   |random  |1C3CCBCGXDN674128|