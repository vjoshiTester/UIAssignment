@AM_Regression13_Recall-STAGE2
Feature: This Test suite is Appointment Management Recall function Regression Test on STAGE2
  Description : to verify Appointment Management function work properly

  @AM_Regression13.1_RecallVehicleService-STAGE2
  Scenario Outline: AM_Regression13.1 ,Verify the Appointment Management Recall function on Vehicle page and Service page
    ...
    Examples: below data set for data driven
      ...
      |STAGE2AL    |Dummy |John Hine Mazda       |             |JM3KE4DE2D0162071 |yes     |51000       |

  @AM_Regression13.2_RecallVehicleService-STAGE2
  ...
  @AM_Regression13.3_RecallVehicleService-STAGE2
  ...
  @AM_Regression13.4_RecallVehicleService-STAGE2
  Scenario Outline: AM_Regression13.4, Verify the Appointment Management Recall function on Vehicle page and Service page
    ...
    Examples: below data set for data driven
      |URL         |DMS   |DealerName            |DealerCode   |VIN               |Recall  | Odometer   |
      |STAGE2AL    |Dummy |Mossy Nissan          |3090         |1N6AA07C68N321957 |no      |56000       |
