@AM_Regression_Others-PROD2
Feature: This Test suite is Appointment Management Regression suite on PROD2
  Description : to verify Appointment Management function work properly


  @AM_Regression02_AdminSettingChanges-PROD2
  Scenario Outline: AM_Regression02, Verify the Administration Employees,Departments, Transportation setting changes in AM
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy     |Administration     |408A85US         |1             |35001    |

  @AM_Regression03_DayWeekMonthView-PROD2
  Scenario Outline: AM_Regression03, Verify the DashBoard able to display properly View layout By DAY,WEEK,MONTH and LIST
    ...
    And I signout from AM
    Examples: below data set for data driven
      |URL          |DMS       |DealerCode       |ServiceAdvisor|Odometer |
      |PROD2ALAUDI  |Dummy     |408A85US         |1             |35001    |

  @AM_Regression04_OEMversionNissan-PROD2
  Scenario Outline: AM_Regression04, Verify the AM Version is correct for OEM Nissan
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALNISS  |Dummy     |Nissan of anytown usa |nissandem2   |2.0.18065.4      |dfx          |54443    |

  @AM_Regression05_OEMversionLexus-PROD2
  Scenario Outline: AM_Regression05 ,Verify the AM Version is correct for OEM Lexus
    ...
    Examples: below data set for data driven
      |URL         |DMS   |DealerName           |DealerCode   |AM_VersionNumber |CustomerName     |Odometer |
      |PROD2ALLEXU |Dummy |Lexus of anytown usa |61204US      |2.0.18065.4      |testing dealer-fx|54443    |

  @AM_Regression06_OEMversionToyota-PROD2
  Scenario Outline: AM_Regression06, Verify the AM Version is correct for OEM Toyota
    ...
    Examples: below data set for data driven
      |URL         |DMS   |DealerName            |DealerCode  |AM_VersionNumber |CustomerName  |Odometer |
      |PROD2ALTOYO |Dummy |Toyota of anytown USA |21072USA    |2.0.18065.4      |dfx           |54443    |

  @AM_Regression07_OEMversionvolkswagen-PROD2
  Scenario Outline: AM_Regression07 Verify the AM Version is correct for OEM volkswagen
    ...
    And I signout from AM
    Examples: below data set for data driven
      |URL         |DMS   |DealerCode  |AM_VersionNumber |CustomerName  |Odometer |
      |PROD2ALVOLK |Dummy |4x0x5x0x2x4 |2.0.18065.4      |vw test       |54443    |

  @AM_Regression08_OEMversionMitsubishi-PROD2
  Scenario Outline: AM_Regression08 Verify the AM Version is correct for OEM Mitsubishi
    ...
    Examples: below data set for data driven
      |URL         |DMS   |DealerName                   |DealerCode   |AM_VersionNumber |CustomerName  |Odometer |
      |PROD2ALMITS |Dummy |Mitsubishi of anytown canada |MITSANYCAN   |2.0.18065.4      |dfx           |54443    |

  @AM_Regression09_FrechLanguage-PROD2
  Scenario Outline: AM_Regression09, Verify the Appointment Management able to display properly French language menu
    ...
    Examples: below data set for data driven
      |URL          |DMS       |UserMenu       |DealerCode       |ServiceAdvisor|Odometer |
      |PROD2ALAUDI  |Dummy     |Language       |408A85US         |1             |35001    |

  @AM_Regression10_SearchCustomerByVIN&Phone-PROD2-AUDI
  Scenario Outline: AM_Regression10, Verify the function the application is able to search customer by the VIN or Phone
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy |Audi of anytown usa  |WA1VGAFPXFA007949 |WAUVGAFR7EA019544 |4162223344 | 4162223344 |

  @AM_Regression11_TransportationOptions-PROD2-AUDI
  Scenario Outline: AM_Regression11 Verify the function of a new appointment able to update on transportation options on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "" or "<DealerCode>" in Dealer Page
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy     |408A85US      |WAUJ8GFFXG1034028  |1             |35001    |

  @AM_Regression12_ChangeDealerShipByUser-PROD2-AUDI
  Scenario Outline: AM_Regression12,  Verify the function of dealer ship able to  be change when change user name
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy     |Audi of anytown usa   |Audi Dallas  |Change dealership |

  @AM_Regression14_ChangeDealerTire-PROD2-AUDI
  Scenario Outline: AM_Regression14 Verify the function of create a new appointment with change Dealer Tire the customer name on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "" or "<DealerCode>" in Dealer Page
    ...
    And I signout from AM
    Examples: below data set for data driven
      |URL          |DMS       |DealerCode  |CustomerName    |ServiceAdvisor|Odometer |
      |PROD2ALAUDI  |Dummy     |4x0x5xAx5x2 |dfx             |1             |35001    |

  @AM_Regression15_CreateNewApptWithoutVIN-PROD2
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy     |Audi of anytown usa  |35001    |

  @AM_Regression16_CreateNewAppointmentByVIN-PROD2-AUDI
  Scenario Outline: @AM_Regression16 Verify the function of create a new appointment with the customer name selection by a VIN
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy     |Audi of anytown usa   |WA1VGAFPXFA007949  |1             |35001    |

  @AM_Regression17_CreateNewApptDifferentDepartment-PROD2
  Scenario Outline: AM_Regression17,Verify the function  of create a new appointment against different department choice
    ...
    Examples: below data set for data driven
      ...
      |PROD2ALAUDI  |Dummy     |Audi of anytown usa  |Main          |Express       |35001    |

  @AM_Regression18.1_SSOAL_NoNamePhoneVIN-PROD2
  ...
  and customer VIN
    Given I launch browser "chrome" in "GUI" and open "PRD2SSOAL"
  ...
  @AM_Regression18.2_SSOAL_NoPhoneVIN-PROD2
  ...
  @AM_Regression18.3_SSOAL_NoNameVIN-PROD2
  ...
  @AM_Regression18.4_SSOAL_NoNamePhone-PROD2
  ...
  @AM_Regression18.5_SSOAL_InvalidPartnerID-PROD2
  ...
  @AM_Regression18.6_SSOAL_InvalidPartnerID-PROD2
  ...
  @AM_Regression18.7_SSOAL_WrongDFXDealerId-PROD2
  ...
  @AM_Regression18.8_SSOAL_InvalidDFXDealerId-PROD2
  ...
  @AM_Regression18.9_SSOAL_InvalidDFXSystemUser-PROD2
  ...
  @AM_Regression19.1_SSOALMit_ValidToday-PROD2
  ...
  Description: login SSO navigation  with valid Dealer Code, User ID on Today
    Given I launch browser "chrome" in "GUI" and open "PRD2ALMITS_SSO"
    When I set "Dummy" to the 'DMS'
  ...
  @AM_Regression19.2_SSOALMit_ValidPreviousday-PROD2
  ...
  @AM_Regression19.3_SSOALMit_ValidEarlierDateday-PROD2
  ...
  @AM_Regression19.4_SSOALMit_InvalidCode-PROD2
  ...
  @AM_Regression19.5_SSOALMit_InvalidCode-PROD2
  ...
  @AM_Regression19.6_SSOALMit_InvalidUser-PROD2
