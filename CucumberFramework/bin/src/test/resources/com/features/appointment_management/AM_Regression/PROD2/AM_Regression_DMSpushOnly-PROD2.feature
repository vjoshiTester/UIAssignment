@AM_Regression_DMSpushOnly-PROD2
Feature: This Test suite is Appointment Management regular Regression suite on PROD2
  Description : to verify Appointment Management function work properly

  @AM_Regression01.1_ALApptCreateAndDelete-PROD2-Dummy
  Scenario Outline: AM_Regression01.1 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
  ...
  @AM_Regression01.2_ALApptCreateAndDelete-PROD2-R&R  @Debug
  Scenario Outline: AM_Regression01.2 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "" or "<DealerCode>" in Dealer Page
    ...
    Examples: below data set for data driven
      |URL          |DMS          |DealerCode    |CustomerName    |ServiceAdvisor|Odometer |
      |PROD2AL      |R&R          |4x0x5xAx5x2   |dfx             |1             |35002    |

  @AM_Regression01.3_ALApptCreateAndDelete-PROD2-CDK
  Scenario Outline: AM_Regression01.3 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "" or "<DealerCode>" in Dealer Page
  ...
  @AM_Regression01.4_ALApptCreateAndDelete-PROD2-DealerTrack  @Debug
  Scenario Outline: AM_Regression01.4 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "" or "<DealerCode>" in Dealer Page
  ...
  @AM_Regression01.5_ALApptCreateAndDelete-PROD2-Automate
  Scenario Outline: AM_Regression01.5 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    ...
    Examples: below data set for data driven
      ...
      |PROD2AL      |Automate     |              |3x8x6x6       |testing         |1             |35005    |

  @AM_Regression01.6_ALApptCreateAndDelete-PROD2-PBS
  Scenario Outline: AM_Regression01.6 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    And I select the Dealer with "<DealerName>" or "<DealerCode>" in Dealer Page
  ...
  @AM_Regression01.6_ALApptCreateAndDelete-PROD2-Serti    @Debug
  Scenario Outline: AM_Regression01.6 <DMS>, Verify the function of create a new appointment and deletion with the customer name selection on PROD2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    ...
    Examples: below data set for data driven
      |URL          |DMS          |DealerName            |DealerCode  |CustomerName   |ServiceAdvisor|Odometer |
      |PROD2AL      |Serti        |Belleville Mitsubishi |80470       |TEST333        |1             |35000    |
