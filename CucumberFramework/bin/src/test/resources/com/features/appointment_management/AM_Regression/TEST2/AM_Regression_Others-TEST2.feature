@AM_Regression_Others-TEST2
Feature: This Test suite is Appointment Management others Regression suite on Test2
  ...
  @AM_Regression03_DayWeekMonthView-TEST2
  Scenario Outline: AM_Regression03, Verify the DashBoard able to display properly View layout By DAY,WEEK,MONTH and LIST
    ...
    Examples: below data set for data driven
      ...
      |TEST2ALAUDI   |Dummy     |Audi of anytown usa   |408A85US         |1             |35001    |
  ...
  Scenario Outline: AM_Regression05 ,Verify the AM Version is correct for OEM Lexus
    ...
    Examples: below data set for data driven
      |URL         |DMS   |DealerName           |DealerCode   |AM_VersionNumber |CustomerName     |Odometer |
      |TST2ALLEXU  |Dummy |Lexus of anytown usa |61204US      |2.0.18065.4      |testing dealer-fx|54443    |
  ...
  @AM_Regression09_FrechLanguage-TEST2
  ...
  Scenario Outline: AM_Regression11 Verify the function of a new appointment able to update on transportation options on Test2
    ...
    Examples: below data set for data driven
      ...
      |TEST2ALAUDI   |Dummy     |408A85US      |WAUJ8GFFXG1034028  |1             |35001    |
  ...
  @AM_Regression15_CreateNewApptWithoutVIN-TEST2
  Scenario Outline: AM_Regression15, Verify the function of create a new appointment Without VIN
    ...
    Examples: below data set for data driven
      ...
      |TEST2ALAUDI   |Dummy     |Audi of anytown usa  |35001    |
  ...
  Scenario Outline: @AM_Regression16 Verify the function of create a new appointment with the customer name selection by a VIN
    ...
    Examples: below data set for data driven
      ...
      |TEST2ALAUDI   |Dummy     |Audi of anytown usa   |WA1VGAFPXFA007949  |1             |35001    |
