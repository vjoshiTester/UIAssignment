@WIAUTOMATEPILOT1 @WIADVISOR
Feature: Automate wiadvisor RO push on PILOT1WI
  ...
  Scenario Outline: wiadvisor testing port from testNG
    ...
    Examples: below data set for data driven
      ...
      |PILOT1WI |Automate   |63401     |Wiadvisor2  |56000   |yes        |1234     |
      |PILOT1WI |CDK        |45155     |push        |38000   |yes        |TEST     |
      |PILOT1WI |DealerTrack|62125     |wiadvisor   |65100   |yes        |TEST     |
      |PILOT1WI |Dummy      |99970     |Olga        |56000   |yes        |TEST     |
      |PILOT1WI |PBS        |45493     |pldfx       |35000   |yes        |TEST     |
      ###  For Prod1 Below ####
      |PROD1WI   |DealerBuilt|26410     |wiadvisor   |45000   |yes        |TEST     |
      |PROD1WI   |Autosoft   |59682     |pldfx       |75000   |yes        |TEST     |
      |PROD1WI   |CDK        |26547     |pldfx       |65000   |yes        |TEST     |
      |PROD1WI   |R&R        |44305     |test        |25777   |yes        |TEST     |
      |PROD1WI   |Dummy      |99970     |testing     |4700    |yes        |TEST     |