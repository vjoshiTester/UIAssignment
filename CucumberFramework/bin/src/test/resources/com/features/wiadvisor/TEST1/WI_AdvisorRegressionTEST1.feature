@WiAdvisor_Regression-TEST1
Feature: The Test suite function to verify the WiAdvisor RO Push work as desire on TEST1
  Description : The purpose of this feature test Diveristy DMS and Data

  @WiAdvisor_Regression-TEST1-Dummy
  Scenario Outline: Test Wi-Advisor function RO push properly on TEST1 <DMS> Dummy and Data set
  Description: verify Wi-Advisor RO push properly on Test1 DMS Dummy and Data set
    ...
    Examples: below data set for data driven
      ...
      |TEST1WI  |Dummy      |99970     |Olga        |56000    | TEST    |

  @WiAdvisor_Regression-TEST1-Automate
  Scenario Outline: Test Wi-Advisor function RO push properly on TEST1 <DMS> Automate and Data set
  Description: Verify Wi-Advisor RO push properly on Test1 DMS CDK  and Data set
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    When I login the WiAdvisor as UserID "T0060VL" and Password "Vadlun1?" and Dealer Code "<DealerCode>"
    And I set "<DMS>" to the 'DMS'
    And I click "Accept" button in 'index' page
    ...
    Examples: below data set for data driven
      |URL      |DMS          |DealerCode|CustomerName     |Odometer|TagNumber|
      |TEST1WI  |Automate     |63401     |Wiadvisor2       |56000   |1234     |

  @WiAdvisor_Regression-TEST1-CDK
  Scenario Outline: Test Wi-Advisor function RO push properly on TEST1 <DMS> CDK and Data set
  Description: Verify Wi-Advisor RO push properly on Test1 DMS CDK  and Data set
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    When I login the WiAdvisor as UserID "T0060VL" and Password "Vadlun1?" and Dealer Code "<DealerCode>"
    And I set "<DMS>" to the 'DMS'
    ...
    Examples: below data set for data driven
      |URL      |DMS          |DealerCode|CustomerName     |Odometer|TagNumber|
      |TEST1WI  |CDK          |26547     |pldfx            |65000   |TEST     |

  @WiAdvisor_Regression-TEST1-PBS
  Scenario Outline: Test Wi-Advisor function RO push properly on TEST1 <DMS> PBS and Data set
  Description: Verify Wi-Advisor RO push properly on Test1 DMS Autosoft and Data set
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    When I login the WiAdvisor as UserID "T0060VL" and Password "Vadlun1?" and Dealer Code "<DealerCode>"
    And I set "<DMS>" to the 'DMS'
    And I click "Accept" button in 'index' page
    ...
    Examples: below data set for data driven
      |URL      |DMS          |DealerCode|CustomerName     |Odometer|TagNumber|
      |TEST1WI  |PBS          |45493     |pldfx            |35000   |TEST     |