...
Feature: The Test suite function to verify the WiAdvisor RO Push work as desire on PILOT1
  ...
  Description: verify Wi-Advisor RO push properly on PILOT1 DMS Dummy and Data set
    ...
    Examples: below data set for data driven
      ...
      |PILOT1WI  |Dummy      |99970     |testing     |4700    |TEST     |

  @WiAdvisorTest_PILOT1-CDK
  ...
  Description: Verify Wi-Advisor RO push properly on PILOT1 DMS CDK  and Data set
    ...
    Examples: below data set for data driven
      |URL      |DMS          |DealerCode|CustomerName     |Odometer|TagNumber|
      |PILOT1WI  |CDK          |26547     |pldfx            |65000   |TEST     |

  @WiAdvisorTest_PILOT1-DealerBuilt
  Scenario Outline: Test Wi-Advisor function RO push properly on PILOT1 <DMS> DealerBuilt and Data set
  Description: Verify Wi-Advisor RO push properly on PILOT1 DMS DealerBuilt and Data set
    ...
    Examples: below data set for data driven
      |URL      |DMS           |DealerCode|CustomerName     |Odometer|TagNumber|
      |PILOT1WI  |DealerBuilt   |26410     |wiadvisor        |45000   |TEST     |

  @WiAdvisorTest_PILOT1-Autosoft
  Scenario Outline: Test Wi-Advisor function RO push properly on PILOT1 <DMS> Autosoft and Data set
  Description: Verify Wi-Advisor RO push properly on PILOT1 DMS Autosoft and Data set
    ...
    Examples: below data set for data driven
      |URL      |DMS           |DealerCode|CustomerName     |Odometer|TagNumber|
      |PILOT1WI  |Autosoft      |59682     |pldfx            |75000   |TEST     |

  @WiAdvisorTest_PILOT1-R&R
  Scenario Outline: Test Wi-Advisor function RO push properly on PILOT1 <DMS> R&R and Data set
  Description: Verify Wi-Advisor RO push properly on PILOT1 DMS R&R and Data set
    ...
    Examples: below data set for data driven
      |URL      |DMS           |DealerCode|CustomerName   |Odometer|TagNumber|
      |PILOT1WI |R&R           |44305     |test           |25777   |TEST     |