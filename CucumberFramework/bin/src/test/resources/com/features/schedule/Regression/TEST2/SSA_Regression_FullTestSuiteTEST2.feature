...
Feature: This Test suite is Schedule Service Appointment Regression suite on Test2
  ...
  @SSA_Regression01_BookApptExistingCustomerByVIN-TEST2
  Scenario Outline: SSARegression01, Verify the function of book a new appointment for an existing customer by VIN in Test2
    ...
    Examples: below data set for data driven
      ...
      |TEST2SSAAUDIS    |WAUDGAFL7BA002147   |9057811444 |999999    |Own ride      |1             |
  ...
  Scenario Outline: SSARegression05, Verify the function of Recall function for an existing customer by VIN on Test2
    ...
    Examples: below data set for data driven
      ...
      |TEST2SSAAUDIR   |JA3AV66VX9U607782   |4162223344 |999999    |yes      |Own ride      |
