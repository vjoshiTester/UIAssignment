@SSA_Regression-TEST1
Feature: This Test suite is Schedule Service Appointment Regression suite on TEST1
  ...
  @SSA_Regression02_BookApptExistingCustomerNotVIN-TEST1
  Scenario Outline: SSARegression02, Verify the function of book a new appointment for an existing customer Not VIN in TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    ...
    Examples: below data set for data driven
      ...
      |TEST1SSAFCAS |Dummy   |Chrysler QA |Own ride      |38000    |1             |

  @SSA_Regression03_BookApptNewCustomerByVIN-TEST1
  Scenario Outline: SSARegression03, Verify the function of book a new appointment for a new customer by VIN in TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I click "I am a new customer" button on 'Search' page in SSA
    ...
    Examples: below data set for data driven
      ...
      |TEST1SSAFCAS |Dummy   |Chrysler QA        |2C3CCARG3EH165106 |47000    |1th             |

  @SSA_Regression04_BookApptNewCustomerNotVIN-TEST1
  Scenario Outline: SSARegression04, Verify the function of book a new appointment for a new customer Not by VIN in TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I click "I am a new customer" button on 'Search' page in SSA
    And I enter vehicle data set on 'Vehicle Info' page in SSA
    ...
    Examples: below data set for data driven
      |URL          |DMS      |DealerName   |Transportation|Odometer |ServiceAdvisor|
      |TEST1SSAFCAS |Dummy   |Chrysler QA  |Own ride      |37800    |1             |

  @SSA_Regression05_RecallVehicleService-TEST1
  Scenario Outline: SSARegression05, Verify the function of Recall function for an existing customer by VIN on TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "Dummy" to the 'DMS'
    When I search "<VIN>" on 'Search' page in SSA
    And I select vehicle on 'Search' page in SSA
    ...
    Examples: below data set for data driven
      ...
      |TEST1SSAFCAR    |JA3AV66VX9U607782   |8552589985 |999999    |yes      |Own ride      |

  @SSA_Regression6.1_OnlineScheduleEnableRecall-TEST1
  Scenario Outline: SSARegression6.1, Verify the function of Enable Online Schedule Recall Setting function on TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    ...
    Examples: below data set for data driven
      ...
      |TEST1DFX     |Dummy |Chrysler QA          |              |1J4RR6GT0BC606832 |

  @SSA_Regression6.2_EnableAppointmentWithoutVIN-TEST1
  Scenario Outline: SSARegression6.2, Verify the function of Enable Appointment Without VIN Setting function on TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    When  I click 'Click Here to Select your Dealership' on 'Home' page
  ...
  @SSA_Regression6.3_DisableAppointmentWithoutVIN-TEST1
  Scenario Outline: SSARegression6.3, Verify the function of disable Appointment Without VIN Setting function on TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    When  I click 'Click Here to Select your Dealership' on 'Home' page
  ...
  @SSA_Regression07_BookApptNoMakeModelByVIN-TEST1
  Scenario Outline: SSARegression07, Verify the function of book a new appointment without Make Model by VIN in TEST1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I click "I am a new customer" button on 'Search' page in SSA
    ...
    Examples: below data set for data driven
      ...
      |TEST1SSAFCAR |Dummy   |ChryslerQA        |1G6DN57P490168257  |42890    |4363        |
