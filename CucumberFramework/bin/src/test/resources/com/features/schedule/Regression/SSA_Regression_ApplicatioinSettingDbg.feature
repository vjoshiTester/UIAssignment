@SSA_Regression6_OnlineScheduleSetting-TEST2-Debug
Feature: This suite is Schedule Service Appointment Online Appointment Setting function Regression suite on Test2
  ...
  Scenario Outline: SSARegression05, Verify the function of Enable Online Schedule Recall Setting function on Test2
  ...
  Scenario Outline: SSARegression05, Verify the function of Enable Appointment Without VIN Setting function on Test2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    When  I click 'Click Here to Select your Dealership' on 'Home' page
  ...
  Scenario Outline: SSARegression05, Verify the function of disable Appointment Without VIN Setting function on Test2
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    When  I click 'Click Here to Select your Dealership' on 'Home' page
