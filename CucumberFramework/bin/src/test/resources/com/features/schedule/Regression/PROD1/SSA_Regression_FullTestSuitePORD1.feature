@SSA_Regression-PROD1
Feature: This PROD1 suite is Schedule Service Appointment Regression suite on PROD1
  Description : to verify a set of functions in Schedule Service Appointment system function work properly

  @SSA_Regression01_BookApptExistingCustomerByVIN-PROD1
  Scenario Outline: SSARegression01, Verify the function of book a new appointment for an existing customer by VIN in PROD1
    ...
    Examples: below data set for data driven
      ...
      |PROD1SSAFCAS    |2B3HD56J5YH215743  |8552589985 |999999    |Own ride      |1             |

  @SSA_Regression02_BookApptExistingCustomerNotVIN-PROD1
  Scenario Outline: SSARegression02, Verify the function of book a new appointment for an existing customer Not VIN in PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    ...
    Examples: below data set for data driven
      ...
      |PROD1SSAFCAS |Dummy   |Chrysler QA |Own ride      |14500    |1             |

  @SSA_Regression03_BookApptNewCustomerByVIN-PROD1
  Scenario Outline: SSARegression03, Verify the function of book a new appointment for a new customer by VIN in PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I click "I am a new customer" button on 'Search' page in SSA
    ...
    And I enter customer data set on 'Appointment Summary' page
      ...
      | Last name      | Shefali                |
      | Phone number   | 8880011982             |
      | Email address  | testdealerfx@gmail.com |
    And I click "Confirm appointment" button on 'Appointment Summary' page
    Then I see "Thank you" message on 'Confirmation' page
    Examples: below data set for data driven
      |URL           |DMS     |DealerName         |VIN                |Odometer |Tranportation   |
      |PROD1SSAFCAS |Dummy   |Chrysler QA        |2C3CCARG3EH165106 |14500    |1th             |

  @SSA_Regression04_BookApptNewCustomerNotVIN-PROD1
  Scenario Outline: SSARegression04, Verify the function of book a new appointment for a new customer Not by VIN in PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I click "I am a new customer" button on 'Search' page in SSA
    And I enter vehicle data set on 'Vehicle Info' page in SSA
  ...
  @SSA_Regression05_RecallVehicleService-PROD1
  Scenario Outline: SSARegression05, Verify the function of Recall function for an existing customer by VIN on PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "Dummy" to the 'DMS'
    When I search "<VIN>" on 'Search' page in SSA
    And I select vehicle on 'Search' page in SSA
    ...
    Examples: below data set for data driven
      ...
      |PROD1SSAFCAR   |JA3AV66VX9U607782   |1J4RR6GT0BC606832 |999999    |yes      |Own ride      |

  @SSA_Regression6.1_OnlineScheduleEnableRecall-PROD1
  Scenario Outline: SSARegression6.1, Verify the function of Enable Online Schedule Recall Setting function on PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    ...
    Examples: below data set for data driven
      ...
      |PROD1DFX     |Dummy |Chrysler QA          |              |1J4RR6GT0BC606832 |

  @SSA_Regression6.2_EnableAppointmentWithoutVIN-PROD1
  Scenario Outline: SSARegression6.2, Verify the function of Enable Appointment Without VIN Setting function on PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    When  I click 'Click Here to Select your Dealership' on 'Home' page
  ...
  @SSA_Regression6.3_DisableAppointmentWithoutVIN-PROD1
  Scenario Outline: SSARegression6.3, Verify the function of disable Appointment Without VIN Setting function on PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I login the Application as User "automation" and password "dealerfxqa"
    When  I click 'Click Here to Select your Dealership' on 'Home' page
  ...
  @SSA_Regression07_BookApptNoMakeModelByVIN-PROD1
  Scenario Outline: SSARegression07, Verify the function of book a new appointment without Make Model by VIN in PROD1
    Given I launch browser "chrome" in "GUI" and open "<URL>"
    And I set "<DMS>" to the 'DMS'
    When I click "I am a new customer" button on 'Search' page in SSA
    ...
    Examples: below data set for data driven
      ...
      |PROD1SSAFCAR   |Dummy   |ChryslerQA        |1G6DN57P490168257  |14500    |4363        |
