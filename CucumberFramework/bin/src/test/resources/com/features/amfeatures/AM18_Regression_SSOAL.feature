@AM18 @Regression2
Feature: AM18_Regression_SSOAL, This test suite is AM Regression for SSO login
  ...
  and customer VIN
    Given I launch browser "chrome" in "GUI" and open "TEST2SSOAL"
